...
import pylab
from main import run_chrome


def draw_graph(analytics_list1, analytics_list2, analytics_list3, total_calories, max_calories, max_jumps, max_squats):
    ...
    dino_header_surface = pygame.Surface((1600, header_height))
    ...
    dino_header_surface.blit(return_header, (return_header_x, return_header_y))
    ...
    dino_header_surface.blit(dino_header, (dino_header_x, dino_header_y))
    dino_header_surface.blit(return_header, (return_header_x, return_header_y))
    screen.blit(dino_header_surface, (0, 0))
    screen.blit(text_surface7, (x7, y7))
    text_surface8 = font3.render("Total calories burnt: " + str(total_calories) + " cal", True, (0, 0, 0))
    text_surface9 = font3.render("Highest Jumps: " + str(max_jumps), True, (0, 0, 0))
    text_surface10 = font3.render("Highest Squats: " + str(max_squats), True, (0, 0, 0))
